        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> 
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="#"> <img src="{{asset('admin/plugins/images/users/varun.jpg')}}" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">{{$taikhoan}}</b></a>
                    </li>
                    <li>

                        <a href="{{ route('admin.get.logout') }}" class="waves-effect">
                          <b>Sign Out </b>
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="{{url('ad/dashboard')}}" class="waves-effect"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i>Trang chủ</a>
                    </li>
                    <li>
                        <a href="{{url('ad/thong-bao')}}" class="waves-effect"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i>Thông báo</a>
                    </li>
                    <li>
                        <a href="{{url('ad/ql-sinh-vien')}}" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Quản lý sinh viên</a>
                    </li>
                    <li>
                        <a href="{{route('admin.phongoc')}}" class="waves-effect"><i class="fa fa-home fa-fw" aria-hidden="true"></i>Quản lý phòng</a>
                    </li>
                    <li>
                        <a href="{{route('admin.dangki')}}" class="waves-effect"><i class="fa fa-th-large fa-fw" aria-hidden="true"></i>Đăng ký nội trú</a>
                    </li>
                    <li>
                        <a href="{{route('admin.hopdong')}}" class="waves-effect"><i class="fa fa-building-o fa-fw" aria-hidden="true"></i>Quản lý hợp đồng</a>
                    </li>
                    <li>
                        <a href="{{route('admin.diennuoc')}}" class="waves-effect"><i class="fa fa-fire fa-fw" aria-hidden="true"></i>Quản lý điện nước</a>
                    </li>
                    <li>
                        <a href="{{route('admin.tinnhan')}}" class="waves-effect"><i class="fa fa-wechat fa-fw" aria-hidden="true"></i>Tin nhắn</a>
                    </li>

    ...
    >
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="{{route('admin.hopdong.huychamduthopdong',$dt->id)}}" target="_blank" class="btn btn-danger pull-right m-l-20 waves-effect waves-light">
              Hủy xác nhận
            </a>
            <a href="{{route('admin.hopdong.dongychamduthopdong',$dt->id)}}" target="_blank" class="btn btn-success pull-right m-l-20 waves-effect waves-light">
                Xác nhận
            </a>
          </td>
        </tr>
